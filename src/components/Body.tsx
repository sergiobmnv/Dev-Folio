...
const TechnologyIcons: { [key: string]: React.FC<React.SVGProps<SVGSVGElement>> } = {
  ...
  nextjs: (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="96" height="96" viewBox="0 0 96 96"><path fillRule="evenodd" clipRule="evenodd" d="M48 0C21.49 0 0 21.49 0 48C0 74.51 21.49 96 48 96C74.51 96 96 74.51 96 48C96 21.49 74.51 0 48 0ZM69.54 71.99L51.98 42.99H65.62V71.99H69.54ZM62.53 71.99V42.99H48.14L29.98 71.99H43.62L52.97 54.17L62.22 71.99H62.53Z" fill="currentColor"/></svg>
  ),
  nodejs: (props) => (
