...
const TechIcons: { [key: string]: React.FC<React.SVGProps<SVGSVGElement>> } = {
  ...
  nodejs: (props) => (
    <svg {...props} viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M9 3V15H5V11H2V13H5V17H9V21H12.5A6.5 6.5 0 0 0 19 14.5V5C17.9 5 17 4.1 17 3H9M15.5 14.5A2.5 2.5 0 0 1 13 17H11V5H15A2 2 0 0 1 17 7V14.5A2.5 2.5 0 0 1 15.5 14.5Z"
      />
    </svg>
  ),
  html: (props) => (
    <svg {...props} viewBox="0 0 24 24">
      <path fill="currentColor" d="M12 2.5L11 2H2L3.5 18H20.5L22 2H13L12 2.5ZM9.5 15.5H6.5L6.25 13H17.75L17.5 15.5H14.5L14.25 18H10L9.5 15.5ZM17.25 11H6.75L6.5 8H17.5L17.25 11Z" />
    </svg>
  ),
  css: (props) => (
    <svg {...props} viewBox="0 0 24 24">
       <path fill="currentColor" d="M2.5 2.5H21.5L20 18.5L12 21.5L4 18.5L2.5 2.5ZM17.5 9.5H11.5V11.5H15.5L15 16.5L12 17.5L9 16.5L8.75 14H10.75L11 15L12 15.25L13 15L13.25 13.5H8.5L8 9.5H11.5V7.5H17.5L17.75 5.5H6.25L6.75 9.5H7.25V7.5H9.5V9.5H6.5L6 5.5H18L17.5 9.5Z" />
    </svg>
  ),
  javascript: (props) => (
    <svg {...props} viewBox="0 0 24 24">
      <path fill="currentColor" d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,16H9V9H11V16M15,16H13V9H15V16Z" />
    </svg>
  ),
  java: (props) => (
    <svg {...props} viewBox="0 0 24 24">
      <path fill="currentColor" d="M14.5,14.25C14.5,15.5,13.6,16.5,12.38,16.5C11.33,16.5,10.5,15.65,10.5,14.53C10.5,13.37,11.41,12.5,12.63,12.5C12.83,12.5,13,12.5,13.15,12.55V10.38C13.15,10.38,13,10.36,12.75,10.36C11.5,10.36,9.85,11.18,9.85,12.83C9.85,14.15,10.5,15.5,12.13,15.5C13.6,15.5,14.5,14.55,14.5,13.2V11H15.85V10.05H14.5V9.11H15.85V8.16H14.5V6H13.15V8.16H11.85V9.11H13.15V10.33C12.8,10.33,12.5,10.25,12.5,10.25C11.36,10.25,10.5,10.95,10.5,12.18C10.5,13.32,11.4,14.25,12.6,14.25C13.5,14.25,14.5,13.5,14.5,11.9V11.23C14.5,11.23,15.2,11.3,15.5,11.75C16.15,12.5,15.8,14.25,14.5,14.25Z" />
    </svg>
  ),
  springboot: (props) => (
    <svg {...props} viewBox="0 0 24 24">
